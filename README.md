...
- [GitHub](https://github.com/jina-ai/jina) (👨‍💻 170 · 🔀 2.1K · 📦 870 · 📋 1.9K - 0% open · ⏱️ 10.08.2023):
...
<details><summary><b><a href="https://github.com/zenml-io/zenml">ZenML</a></b> (🥉30 ·  ⭐ 3K · 📉) - ZenML : Build portable, production-ready MLOps pipelines. https://zenml.io. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/zenml-io/zenml) (👨‍💻 73 · 🔀 310 · 📥 1 · 📦 130 · 📋 200 - 5% open · ⏱️ 21.07.2023):
...
- [GitHub](https://github.com/ml-tooling/opyrator) (👨‍💻 4 · 🔀 140 · 📦 46 · ⏱️ 06.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/opyrator) (📥 130 / month):
	```
...
<details><summary><b><a href="https://github.com/developmentseed/pydantic-ssm-settings">pydantic-ssm-settings</a></b> (🥈9 ·  ⭐ 16 · 📉) - Replace Pydantics builtin Secret Support with a configuration provider that loads parameters from AWS Systems Manager.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/developmentseed/pydantic-ssm-settings) (👨‍💻 4 · 🔀 2 · 📥 21 · ⏱️ 26.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/pydantic-ssm-settings) (📥 960 / month):
	```
...
- [GitHub](https://github.com/andrewthetechie/pydantic-sqs) (👨‍💻 2 · ⏱️ 10.08.2023):

	```
	git clone https://github.com/andrewthetechie/pydantic-sqs
	```
- [PyPi](https://pypi.org/project/pydantic-sqs) (📥 39 / month):
	```
...
- [GitHub](https://github.com/tiangolo/sqlmodel) (👨‍💻 53 · 🔀 440 · 📦 6.8K · 📋 320 - 54% open · ⏱️ 01.08.2023):

	```
	git clone https://github.com/tiangolo/sqlmodel
	```
- [PyPi](https://pypi.org/project/sqlmodel) (📥 490K / month):
	```
...
- [GitHub](https://github.com/collerek/ormar) (👨‍💻 31 · 🔀 70 · 📦 850 · 📋 240 - 26% open · ⏱️ 08.08.2023):

	```
	git clone https://github.com/collerek/ormar
	```
- [PyPi](https://pypi.org/project/ormar) (📥 40K / month):
	```
	pip install ormar
	```
</details>
...
- [GitHub](https://github.com/codemation/pydbantic) (👨‍💻 9 · 🔀 11 · 📦 12 · 📋 19 - 15% open · ⏱️ 15.04.2023):

	```
	git clone https://github.com/codemation/pydbantic
	```
- [PyPi](https://pypi.org/project/pydbantic) (📥 630 / month):
	```
...
- [GitHub](https://github.com/roman-right/beanie) (👨‍💻 49 · 🔀 130 · 📦 1.3K · 📋 280 - 13% open · ⏱️ 03.08.2023):

	```
	git clone https://github.com/roman-right/beanie
	```
- [PyPi](https://pypi.org/project/beanie) (📥 100K / month):
	```
	pip install beanie
	```
</details>
...
- [GitHub](https://github.com/aminalaee/mongox) (👨‍💻 8 · 🔀 8 · 📦 5 · 📋 16 - 18% open · ⏱️ 09.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/mongox) (📥 89 / month):
	```
	pip install mongox
	```
</details>
...
- [GitHub](https://github.com/ontolocy/neontology) (🔀 2 · ⏱️ 25.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/neontology) (📥 65 / month):
	```
...
<details><summary><b><a href="https://github.com/redis/redis-om-python">redisOM</a></b> (🥇22 ·  ⭐ 800) - Object mapping, and more, for Redis and Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/redis/redis-om-python) (👨‍💻 22 · 🔀 81 · 📦 590 · 📋 190 - 55% open · ⏱️ 18.07.2023):
...
<details><summary><b><a href="https://github.com/andrewthetechie/pydantic-aioredis">pydantic-aioredis</a></b> (🥉16 ·  ⭐ 42) - A Declarative ORM for Redis using Pydantic Models and aioredis. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/andrewthetechie/pydantic-aioredis) (👨‍💻 6 · 🔀 4 · 📦 6 · 📋 26 - 3% open · ⏱️ 12.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/pydantic-aioredis) (📥 440 / month):
	```
...
- [GitHub](https://github.com/elementary-data/elementary) (👨‍💻 52 · 🔀 100 · 📦 23 · 📋 350 - 32% open · ⏱️ 10.08.2023):
...
- [GitHub](https://github.com/kolonialno/patito) (👨‍💻 2 · 🔀 7 · 📦 5 · 📋 29 - 89% open · ⏱️ 29.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/patito) (📥 830 / month):
	```
	pip install patito
	```
</details>
...
- <b><a href="https://github.com/godatadriven/pydantic-spark">pydantic-spark</a></b> (🥉11 ·  ⭐ 18) -  <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
</details>
<br>
...
- [GitHub](https://github.com/unionai-oss/pandera) (👨‍💻 100 · 🔀 200 · 📦 980 · 📋 630 - 35% open · ⏱️ 18.07.2023):

	```
	git clone https://github.com/unionai-oss/pandera
	```
- [PyPi](https://pypi.org/project/pandera) (📥 960K / month):
	```
	pip install pandera
	```
</details>
...
- [GitHub](https://github.com/developmentseed/geojson-pydantic) (👨‍💻 22 · 🔀 33 · 📦 270 · 📋 57 - 1% open · ⏱️ 24.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/geojson-pydantic) (📥 74K / month):
	```
	pip install geojson-pydantic
	```
</details>
<details><summary><b><a href="https://github.com/gb-libs/pydantic-geojson">pydantic-geojson</a></b> (🥉10 ·  ⭐ 11) - Pydantic validation for GeoJson. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/gb-libs/pydantic-geojson) (👨‍💻 6 · 🔀 4 · 📋 9 - 22% open · ⏱️ 13.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/pydantic-geojson) (📥 5.4K / month):
	```
...
- [GitHub](https://github.com/artsmolin/pythogen) (👨‍💻 10 · 🔀 6 · 📋 20 - 15% open · ⏱️ 10.08.2023):
...
- [GitHub](https://github.com/yezz123/pyngo) (👨‍💻 5 · 🔀 5 · 📦 5 · 📋 2 - 50% open · ⏱️ 03.08.2023):

	```
	git clone https://github.com/yezz123/pyngo
	```
- [PyPi](https://pypi.org/project/pyngo) (📥 7.9K / month):
	```
	pip install pyngo
	```
</details>
...
- [GitHub](https://github.com/Maillol/aiohttp-pydantic) (👨‍💻 7 · 🔀 14 · 📋 20 - 35% open · ⏱️ 12.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/aiohttp-pydantic) (📥 4.7K / month):
	```
...
- [GitHub](https://github.com/strawberry-graphql/strawberry) (👨‍💻 220 · 🔀 430 · 📥 380 · 📦 2.1K · 📋 790 - 38% open · ⏱️ 10.08.2023):
...
<details><summary><b><a href="https://github.com/impocode/jsonapi-pydantic">jsonapi-pydantic</a></b> (🥇8 ·  ⭐ 1 · 📈) - jsonapi-pydantic provides a suite of Pydantic models matching the JSON:API specification. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/impocode/jsonapi-pydantic) (📥 26 · ⏱️ 04.08.2023):
...
- [GitHub](https://github.com/tiangolo/fastapi) (👨‍💻 490 · 🔀 5K · 📦 220K · 📋 3.3K - 0% open · ⏱️ 10.08.2023):
...
<details><summary><b><a href="https://github.com/litestar-org/litestar">litestar</a></b> (🥉31 ·  ⭐ 2.5K) - Light, Flexible and Extensible ASGI API framework | Effortlessly Build Performant APIs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/litestar-org/litestar) (👨‍💻 130 · 🔀 220 · 📦 99 · 📋 610 - 9% open · ⏱️ 10.08.2023):

	```
	git clone https://github.com/litestar-org/litestar
	```
- [PyPi](https://pypi.org/project/litestar) (📥 5.3K / month):
	```
...
- [GitHub](https://github.com/robusta-dev/robusta) (👨‍💻 51 · 🔀 180 · 📦 210 · 📋 200 - 56% open · ⏱️ 10.08.2023):

	```
	git clone https://github.com/robusta-dev/robusta
	```
- [PyPi](https://pypi.org/project/robusta) (📥 60 / month):
	```
	pip install robusta
	```
</details>
...
- [GitHub](https://github.com/microsoft/onefuzz) (👨‍💻 33 · 🔀 180 · 📥 15K · 📦 10 · 📋 870 - 21% open · ⏱️ 10.08.2023):
...
<details><summary><b><a href="https://github.com/dapper91/pydantic-xml">pydantic-xml</a></b> (🥇20 ·  ⭐ 71) - pydantic xml extension. <code><a href="http://bit.ly/3rvuUlR">Unlicense</a></code></summary>

- [GitHub](https://github.com/dapper91/pydantic-xml) (👨‍💻 6 · 🔀 10 · 📦 25 · 📋 31 - 22% open · ⏱️ 14.07.2023):
...
<details><summary><b><a href="https://github.com/tefra/xsdata-pydantic">xsdata-pydantic</a></b> (🥉10 ·  ⭐ 26) - Naive XML & JSON Bindings for python pydantic classes!. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/tefra/xsdata-pydantic) (👨‍💻 2 · 🔀 3 · 📋 11 - 36% open · ⏱️ 25.07.2023):

	```
	git clone https://github.com/tefra/xsdata-pydantic
	```
- [PyPi](https://pypi.org/project/xsdata-pydantic) (📥 1.3K / month):
	```
